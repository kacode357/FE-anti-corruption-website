export const homeTranslations = {
  vi: {
    ...
    // THÊM: TÁC HẠI CỦA THAM NHŨNG
    content7: {
      title: "Tác hại của Tham nhũng",
      description:
        "Phân tích các hậu quả tiêu cực của tham nhũng đối với chính trị, kinh tế, và đạo đức xã hội. Hiểu rõ tác hại để đấu tranh hiệu quả hơn.",
      details: "Gây mất lòng tin, cản trở phát triển kinh tế, suy đồi đạo đức",
    },
  },
  en: {
    ...
    // ADDED: HARMS OF CORRUPTION
    content7: {
      title: "Harms of Corruption",
      description:
        "Analyzing the negative consequences of corruption on politics, economics, and social ethics. Understanding the harms for a more effective fight.",
      details: "Loss of trust, hindering economic development, moral degradation",
    },
  },
}
